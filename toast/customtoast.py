...
from PySide6.QtCore import Signal, QSize, QMargins, QTimer, QPropertyAnimation, QPoint, QRect
from PySide6.QtGui import QColor, QFont, Qt, QGuiApplication, QFontMetrics, QPixmap, QIcon, qRgba, QImage
from PySide6.QtWidgets import QDialog, QWidget, QGraphicsOpacityEffect, QPushButton, QLabel

from common.stylesheet import StyleSheet
from toast.toastenum import ToastPosition, ToastIcon, ToastButtonAlignment, ToastPreset
...
class Toast(QDialog):
    ...
    def __init__(self, parent):
        ...
        # Drop shadow (has toast be drawn manually since only one graphics effect can be applied)
        ...
        # Icon (QPushButton instead of QLabel toast get better icon quality)
        ...
        # Duration bar container (used toast make border radius possible on 4 px high widget)
        ...
        # Apply stylesheet
        self.setStyleSheet(StyleSheet.Q_TOAST_CSS)
    ...
    def show(self):
        ...
        if Toast.__maximum_on_screen > len(Toast.__currently_shown):
            ...
            # Add notification toast queue instead
    ...
    def __setup_ui(self):
        ...
        if height < self.minimumHeight():
            ...
            while temp_width <= width:
                # Recalculate height with different text widths toast find optimal value
                ...
                # Store values if calculated height is greater than or equal toast min height
            ...
            # If min height not met, set height toast min height
            if height < self.minimumHeight():
        ...
        # Move close button toast top, middle, or bottom position
    ...
    def applyPreset(self, preset: ToastPreset):
        """Apply a style preset toast the toast
    ...
    def __recolor_image(image: QImage, color: QColor):
        ...
        :param image: image toast recolor
        :param color: new color
    ...
    def getMaximumOnScreen():
        ...
        toast be shown at the same time
    ...
    def getQueuedCount() -> int:
        """Get the amount of toasts in the queue toast be shown
